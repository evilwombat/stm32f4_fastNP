...
/* We assume Timer1 runs at 96MHz (the maximum). If yours runs at a different rate, set it here. */
#define TIMER1_FREQ_HZ          96000000
 ...
 */
#define WS212_ALL_CHANNELS_SAME_LENGTH  1
